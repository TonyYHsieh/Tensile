...
// v[vgprLocalReadAddrA] = sgid * (MT1+PAD) * MFMA_K + ((lid / MFMA_MN) * (MT1+PAD)) * (MT1+PAD) + (lid % MFMA_MN)
...
_v_add_lshl_u32 v[vgprLocalReadAddrA], v0, v4, 0x2 // vgprLocalReadAddrA = (lr0I * VW + sgid * (MT0 + PAD)) * bpe
...
v_accvgpr_write_b32 a0,  v[vgprValuC+0]
v_accvgpr_write_b32 a1,  v[vgprValuC+1]
v_accvgpr_write_b32 a2,  v[vgprValuC+2]
v_accvgpr_write_b32 a3,  v[vgprValuC+3]
v_accvgpr_write_b32 a4,  v[vgprValuC+4]
v_accvgpr_write_b32 a5,  v[vgprValuC+5]
v_accvgpr_write_b32 a6,  v[vgprValuC+6]
v_accvgpr_write_b32 a7,  v[vgprValuC+7]
v_accvgpr_write_b32 a8,  v[vgprValuC+8]
v_accvgpr_write_b32 a9,  v[vgprValuC+9]
v_accvgpr_write_b32 a10, v[vgprValuC+10]
v_accvgpr_write_b32 a11, v[vgprValuC+11]
v_accvgpr_write_b32 a12, v[vgprValuC+12]
v_accvgpr_write_b32 a13, v[vgprValuC+13]
v_accvgpr_write_b32 a14, v[vgprValuC+14]
v_accvgpr_write_b32 a15, v[vgprValuC+15]
...
ds_read_b32 v[vgprValuA_X0_I0+0], v[vgprLocalReadAddrA] offset:0  // read a
ds_read_b32 v[vgprValuB_X0_I0+0], v[vgprLocalReadAddrB] offset:0  // read b
s_waitcnt lgkmcnt(0)
