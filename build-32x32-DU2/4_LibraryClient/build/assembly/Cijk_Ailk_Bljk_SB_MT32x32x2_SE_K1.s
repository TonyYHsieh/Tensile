...
.text
.protected Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1
.globl Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1
.p2align 8
.type Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1,@function
.amdgpu_hsa_kernel Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1
Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1:
.amd_kernel_code_t
  is_ptr64 = 1
  ...
  workgroup_group_segment_byte_size = 1636 // lds bytes
...
Version: [ 1, 0 ]
Kernels:
  - Name: Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1
    SymbolName: 'Cijk_Ailk_Bljk_SB_MT32x32x2_SE_K1@kd'
    Language: OpenCL C
    LanguageVersion: [ 2, 0 ]
    Args:
      - Name:            sizeC
...
s_mov_b32 m0, 0x664                                // LDS clamp at 1636 bytes
...
v_lshrrev_b32 v2, 1, v[vgprSerial]                 // vectorStaticDiv: v2 = v[vgprSerial] / 2
v_and_b32 v3, 1, v[vgprSerial]                     // vectorStaticDiv: v3 = v[vgprSerial] % 2
...
s_mul_i32 s[sgprGlobalReadIncsA+0], 0x8, s[sgprStrideAL] // incrAL = strideL*2*bpe (unrollIdx)


/* global read addresses: increments b */

s_mov_b32 s[sgprGlobalReadIncsB+0], 0x8            // incr = 2*bpe
...
_v_add_co_u32 v[vgprLocalWriteAddrB], vcc, 0x100, v[vgprLocalWriteAddrB] // lwFOB = lwB1J + lwBL*MT1J + LDS_OFFSET_B=64*4
...
s_lshr_b32 s[sgprLoopCounters+0], s[sgprSizesSum+0], 1 // s[sgprLoopCounters+0] = s[sgprSizesSum+0] / 2
...
s_and_b32 s[sgprLoopCounters+0], 1, s[sgprSizesSum+0] // s[sgprLoopCounters+0] = s[sgprSizesSum+0] % 2
...
s_mov_b32 s71, 0x80                                // inc
_v_add_co_u32 v[vgprLocalReadAddrA], vcc, s71, v[vgprLocalReadAddrA] // lrA += 128 (LSU*(MT+PAD)*bpe)


/* local read inc b */

s_mov_b32 s71, 0x80                                // inc
_v_add_co_u32 v[vgprLocalReadAddrB], vcc, s71, v[vgprLocalReadAddrB] // lrB += 128 (LSU*(MT+PAD)*bpe)
