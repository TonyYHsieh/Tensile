...
var varlds_Asize_per_wave = varlds_Asize_per_wr * 8   //each wave load 8 64X2 block one time.  need contiunous 64X2X8X2=2048 bytes in LDS
...
shader main
  ...
  ds_write_b128      v[vgprLocalWriteAddrA+0],  v[vgprG2LA+0+4]  offset:varlds_Asize_per_wr * 4

  s_waitcnt vmcnt(6)
  ds_write_b128      v[vgprLocalWriteAddrB+0],  v[vgprG2LB+ 0+ 0]  offset:0
  ds_write_b128      v[vgprLocalWriteAddrB+0],  v[vgprG2LB+ 0+ 4]  offset:varlds_Bsize_per_wr * 4
  ds_write_b128      v[vgprLocalWriteAddrB+0],  v[vgprG2LB+ 0+ 8]  offset:varlds_Bsize_per_wr * 8
  ds_write_b128      v[vgprLocalWriteAddrB+0],  v[vgprG2LB+ 0+12]  offset:varlds_Bsize_per_wr * 12
...
label_0005:
  ...
  ds_write_b128      v[vgprLocalWriteAddrA+1],  v[vgprG2LA+8+4]  offset:varlds_Asize_per_wr * 4

  s_waitcnt vmcnt(6)
  ds_write_b128      v[vgprLocalWriteAddrB+1],  v[vgprG2LB+16+ 0]  offset:0
  ds_write_b128      v[vgprLocalWriteAddrB+1],  v[vgprG2LB+16+ 4]  offset:varlds_Bsize_per_wr * 4
  ds_write_b128      v[vgprLocalWriteAddrB+1],  v[vgprG2LB+16+ 8]  offset:varlds_Bsize_per_wr * 8
  ds_write_b128      v[vgprLocalWriteAddrB+1],  v[vgprG2LB+16+12]  offset:varlds_Bsize_per_wr * 12
