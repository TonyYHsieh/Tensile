...
.amd_kernel_code_t
  ...
  workitem_vgpr_count = 39 // vgprs
  wavefront_sgpr_count = 92 // sgprs
  compute_pgm_rsrc1_vgprs = 9 // floor((39-1)/4)
...
s_sub_i32 s77, 2, s[sgprStaggerUIter]              // 
...
Summation_End_11:
/* endSummation: add vgpr 16...36 to pool */
...
/* Global Write Edge Batch #0 (d1,d0,vc1,vc0) =
   (0,0,0,0:vw1); (0,1,0,0:vw1); (0,2,0,0:vw1); (0,3,0,0:vw1); (1,0,0,0:vw1); (1,1,0,0:vw1); (1,2,0,0:vw1); (1,3,0,0:vw1); (2,0,0,0:vw1); (2,1,0,0:vw1); (2,2,0,0:vw1); (2,3,0,0:vw1); (3,0,0,0:vw1); (3,1,0,0:vw1); (3,2,0,0:vw1) */
/******************************************/
...
/* rC *= alpha batchEements=[(0, 0, 0, 0), (0, 1, 0, 0), (0, 2, 0, 0), (0, 3, 0, 0), (1, 0, 0, 0), (1, 1, 0, 0), (1, 2, 0, 0), (1, 3, 0, 0), (2, 0, 0, 0), (2, 1, 0, 0), (2, 2, 0, 0), (2, 3, 0, 0), (3, 0, 0, 0), (3, 1, 0, 0), (3, 2, 0, 0)] */
v_mul_f32 v[vgprValuC+0], s[sgprAlpha], v[vgprValuC+0] // *= alpha
v_mul_f32 v[vgprValuC+1], s[sgprAlpha], v[vgprValuC+1] // *= alpha
v_mul_f32 v[vgprValuC+2], s[sgprAlpha], v[vgprValuC+2] // *= alpha
v_mul_f32 v[vgprValuC+3], s[sgprAlpha], v[vgprValuC+3] // *= alpha
...
/* Global Write Beta Batch #0 (d1,d0,vc1,vc0) =
   (0,0,0,0:vw1); (0,1,0,0:vw1); (0,2,0,0:vw1); (0,3,0,0:vw1); (1,0,0,0:vw1); (1,1,0,0:vw1); (1,2,0,0:vw1); (1,3,0,0:vw1); (2,0,0,0:vw1); (2,1,0,0:vw1); (2,2,0,0:vw1); (2,3,0,0:vw1); (3,0,0,0:vw1); (3,1,0,0:vw1) */
/******************************************/
...
/* rC *= alpha batchEements=[(0, 0, 0, 0), (0, 1, 0, 0), (0, 2, 0, 0), (0, 3, 0, 0), (1, 0, 0, 0), (1, 1, 0, 0), (1, 2, 0, 0), (1, 3, 0, 0), (2, 0, 0, 0), (2, 1, 0, 0), (2, 2, 0, 0), (2, 3, 0, 0), (3, 0, 0, 0), (3, 1, 0, 0)] */
v_mul_f32 v[vgprValuC+0], s[sgprAlpha], v[vgprValuC+0] // *= alpha
v_mul_f32 v[vgprValuC+1], s[sgprAlpha], v[vgprValuC+1] // *= alpha
v_mul_f32 v[vgprValuC+2], s[sgprAlpha], v[vgprValuC+2] // *= alpha
v_mul_f32 v[vgprValuC+3], s[sgprAlpha], v[vgprValuC+3] // *= alpha
...
/* calc coords, apply mask, and issue loads (if necessary) */
/* (d1,vc1,d0,vc0)=(3,0,2,0) */
buffer_load_dword v22, v21, s[sgprSrdC:sgprSrdC+3], 0, offen offset:64 // load C for beta calc
/* (d1,vc1,d0,vc0)=(3,0,3,0) */
buffer_load_dword v23, v21, s[sgprSrdC:sgprSrdC+3], 0, offen offset:96 // load C for beta calc
...
v_mac_f32 v[vgprValuC+14], v22, s[sgprBeta]        // finalSum = sum*alpha + C*beta
buffer_store_dword v14, v21, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:64,  // store D

s_waitcnt vmcnt(1)                                 // wait C (interleaved)
v_mac_f32 v[vgprValuC+15], v23, s[sgprBeta]        // finalSum = sum*alpha + C*beta
buffer_store_dword v15, v21, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:96,  // store D
s_branch label_0025                                // jump to end
GW_B1_E1_24:
...
v_cmp_lt_u32 s[72:73], v17, s[sgprSizeC1J]         // coord1 < size1
s_and_b64 s[72:73], s[56:57], s[72:73]             // in0 && in1
_v_add_lshl_u32 v31, v18, v16, 0x2                 // scaleToBpe: accumulate d0 lower and *= bpe into Cin addr
v_cndmask_b32 v31, -1, v31, s[72:73]               // clip if OOB. offset
buffer_load_dword v32, v31, s[sgprSrdC:sgprSrdC+3], 0, offen offset:0 // load C for beta calc
/* (d1,vc1,d0,vc0)=(3,0,1,0) */
_v_add_co_u32 v19, vcc, v16, 8                     // coord0.1: coord0 += d0*sg0*VW + vc0
...
/* apply mask, calc new C and issue write */
v_mac_f32 v[vgprValuC+7], v22, s[sgprBeta]         // finalSum = sum*alpha + C*beta
...
buffer_store_dword v8, v23, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0,  // store D
v_mac_f32 v[vgprValuC+9], v26, s[sgprBeta]         // finalSum = sum*alpha + C*beta
buffer_store_dword v9, v25, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0,  // store D
v_mac_f32 v[vgprValuC+10], v28, s[sgprBeta]        // finalSum = sum*alpha + C*beta
buffer_store_dword v10, v27, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0,  // store D
v_mac_f32 v[vgprValuC+11], v30, s[sgprBeta]        // finalSum = sum*alpha + C*beta
buffer_store_dword v11, v29, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0,  // store D
v_mac_f32 v[vgprValuC+12], v32, s[sgprBeta]        // finalSum = sum*alpha + C*beta
buffer_store_dword v12, v31, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0,  // store D
v_mac_f32 v[vgprValuC+13], v34, s[sgprBeta]        // finalSum = sum*alpha + C*beta
buffer_store_dword v13, v33, s[sgprSrdD:sgprSrdD+3], 0, offen, offset:0,  // store D
/* optSingleColVgpr=0 optSharedColVgpr=0 optSharedMask=0 optSrdIncForRow=0 */
...
v_mac_f32 v[vgprValuC+15], v24, s[sgprBeta]        // finalSum = sum*alpha + C*beta
