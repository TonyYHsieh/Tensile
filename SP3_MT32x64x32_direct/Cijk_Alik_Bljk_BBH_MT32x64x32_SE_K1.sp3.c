...
shader main
  ...
  //LVCA= 16
  //glvw = 1
  v_lshrrev_b32    v0,   4, v[vgprSerial+1]                           // v[vgprSerial+1] / 16
  v_mul_lo_u32     v4,   s[sgprStridesA+0],  v0                       // v[vgprSerial+1] / 16 * sgprStridesA
  v_and_b32        v1,   15, v[vgprSerial+1]                          // v[vgprSerial+1] % 16
  ...
  s_lshl_b32       s[sgprScalarGlobalReadOffsetB+0], s[sgprStridesB+0], 3              // x8 = X4(4 lines) X2(conver to bytes).
...
wave0_entry_start:
  ...
  v_lshrrev_b32    v2, 2, v1                          // 4 lines 1 padding
  ...
  v_lshrrev_b32    v2, 2,  v1                         // 2 lines 1 padding
  v_mul_lo_u32     v2, varlds_pad, v2
  ...
  ds_read_b32       v[vgprValuA_X0_I0+0*16+1*8+0],  v[vgprLocalReadAddrA+0]  offset:  0 + varlds_Asize_per_wr * 4
  ds_read_b32       v[vgprValuA_X0_I0+0*16+0*8+1],  v[vgprLocalReadAddrA+0]  offset: 16
  ds_read_b32       v[vgprValuA_X0_I0+0*16+1*8+1],  v[vgprLocalReadAddrA+0]  offset: 16 + varlds_Asize_per_wr * 4
  ds_read_b32       v[vgprValuA_X0_I0+0*16+0*8+2],  v[vgprLocalReadAddrA+0]  offset: 32
  ds_read_b32       v[vgprValuA_X0_I0+0*16+1*8+2],  v[vgprLocalReadAddrA+0]  offset: 32 + varlds_Asize_per_wr * 4
  ds_read_b32       v[vgprValuA_X0_I0+0*16+0*8+3],  v[vgprLocalReadAddrA+0]  offset: 48
  ds_read_b32       v[vgprValuA_X0_I0+0*16+1*8+3],  v[vgprLocalReadAddrA+0]  offset: 48 + varlds_Asize_per_wr * 4
...
//     ds_read_b32       v_regs(vgprValuB_X0_I0, p* 8+    7),  v_regs(vgprLocalReadAddrB,p)  offset:112
     ...
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+1*8+0),  v_regs(vgprLocalReadAddrA,k)  offset:  0 + varlds_Asize_per_wr * 4
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+0*8+1),  v_regs(vgprLocalReadAddrA,k)  offset: 16
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+1*8+1),  v_regs(vgprLocalReadAddrA,k)  offset: 16 + varlds_Asize_per_wr * 4
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+0*8+2),  v_regs(vgprLocalReadAddrA,k)  offset: 32
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+1*8+2),  v_regs(vgprLocalReadAddrA,k)  offset: 32 + varlds_Asize_per_wr * 4
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+0*8+3),  v_regs(vgprLocalReadAddrA,k)  offset: 48
     ds_read_b32       v_regs(vgprValuA_X0_I0, k*16+1*8+3),  v_regs(vgprLocalReadAddrA,k)  offset: 48 + varlds_Asize_per_wr * 4
...
//     ds_read_b32       v_regs(vgprValuB_X0_I0, 0* 8+    7),  v_regs(vgprLocalReadAddrB,0)  offset:112
     ...
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+1*8+0),  v_regs(vgprLocalReadAddrA,1)  offset:  0 + varlds_Asize_per_wr * 4
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+0*8+1),  v_regs(vgprLocalReadAddrA,1)  offset: 16
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+1*8+1),  v_regs(vgprLocalReadAddrA,1)  offset: 16 + varlds_Asize_per_wr * 4
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+0*8+2),  v_regs(vgprLocalReadAddrA,1)  offset: 32
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+1*8+2),  v_regs(vgprLocalReadAddrA,1)  offset: 32 + varlds_Asize_per_wr * 4
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+0*8+3),  v_regs(vgprLocalReadAddrA,1)  offset: 48
     ds_read_b32       v_regs(vgprValuA_X0_I0, 1*16+1*8+3),  v_regs(vgprLocalReadAddrA,1)  offset: 48 + varlds_Asize_per_wr * 4
