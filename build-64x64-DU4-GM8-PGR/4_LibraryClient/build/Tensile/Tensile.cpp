...
namespace { // Start schedule 'hip'
// solution table - function, name, assertion requirements
static const SolutionInfo solutionTable_hip_Cijk_Ailk_Bljk_SB[] = {
  {(void*)Cijk_Ailk_Bljk_SB_MT64x64x4_SE_, "Cijk_Ailk_Bljk_SB_MT64x64x4_SE_", {1, 1, 1, 0, 1, 0, 0} } // 0
};

// table of exact problem dims and selected solutionIdx
static const std::pair<const ProblemKey_Cijk_Ailk_Bljk_SB, int> embeddedExactTable_hip_Cijk_Ailk_Bljk_SB[] = {
 { {64, 64, 1, 4}, 0}  // 0 GFlop/s
};
...
static SolutionMapper_Cijk_Ailk_Bljk_SB solutionMapper_hip_Cijk_Ailk_Bljk_SB(
  "hip_Cijk_Ailk_Bljk_SB", // schedule+problem name
  solutionTable_hip_Cijk_Ailk_Bljk_SB, 1,
  embeddedExactTable_hip_Cijk_Ailk_Bljk_SB, 1,
...
void tensileInitialize() {
  ...
  solutionMapper_hip_Cijk_Ailk_Bljk_SB.initializeMappers({"Device 0000"},&masterSolutionMapper_Cijk_Ailk_Bljk_SB);
}