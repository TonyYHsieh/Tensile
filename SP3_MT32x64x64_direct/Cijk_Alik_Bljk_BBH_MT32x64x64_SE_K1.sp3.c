...
label_0001:
  ...
  for var p =0; p < 2; p++
     ...
     ds_read_b32       v_regs(vgprValuB_X0_I0, p* 8+    6),  v_regs(vgprLocalReadAddrB,p)  offset:96
     ds_read_b32       v_regs(vgprValuB_X0_I0, p* 8+    7),  v_regs(vgprLocalReadAddrB,p)  offset:112
...
//          v_mov_b32 v_regs(vgprValuC, j), v[vgprSerial]
