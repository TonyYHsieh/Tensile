...
.text
.protected Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1
.globl Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1
.p2align 8
.type Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1,@function
.amdgpu_hsa_kernel Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1
Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1:
.amd_kernel_code_t
  is_ptr64 = 1
  ...
  workgroup_group_segment_byte_size = 52224// lds bytes
...
Version: [ 1, 0 ]
Kernels:
  - Name: Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1
    SymbolName: 'Cijk_Alik_Bljk_BBH_MT32x64x128_SE_K1@kd'
    Language: OpenCL C
    LanguageVersion: [ 2, 0 ]
    Args:
      - Name:            sizeC
