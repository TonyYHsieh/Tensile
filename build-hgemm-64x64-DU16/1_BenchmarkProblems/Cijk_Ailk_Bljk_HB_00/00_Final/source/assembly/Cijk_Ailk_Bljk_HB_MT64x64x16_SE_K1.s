...
_v_add_lshl_u32 v[vgprLocalReadAddrA], v0, v2, 0x1 // 3. v[vgprLocalReadAddrA] = (lr0I + (lrL*(MT0+PAD)) + (waveIdx * MFMA_M_N) + (sgid * MFMA_K * (MT0+PAD))) * 4(bpe)
...
_v_add_lshl_u32 v[vgprLocalReadAddrB], v0, v2, 0x1 // 3. v[vgprLocalReadAddrA] = (lr0I + (lrL*(MT0+PAD)) + (waveIdx * MFMA_M_N) + (sgid * MFMA_K * (MT0+PAD))) * 4(bpe)
...
/* local read a */
ds_read_b32 v[vgprValuC+0], v[vgprLocalReadAddrA] offset:0   // offset : (iter(0) * MT0 * MFMA_K + MT0 * 0) * bpe(2)
ds_read_b32 v[vgprValuC+1], v[vgprLocalReadAddrA] offset:128 // offset : (iter(0) * MT0 * MFMA_K + MT0 * 1) * bpe(2)
ds_read_b32 v[vgprValuC+2], v[vgprLocalReadAddrA] offset:256 // offset : (iter(0) * MT0 * MFMA_K + MT0 * 2) * bpe(2)
ds_read_b32 v[vgprValuC+3], v[vgprLocalReadAddrA] offset:384 // offset : (iter(0) * MT0 * MFMA_K + MT0 * 3) * bpe(2)

/* local read b */
ds_read_b32 v[vgprValuC+4], v[vgprLocalReadAddrB] offset:0   // offset : (iter(1) * MT1 * MFMA_K + MT1 * 0) * bpe(2)
ds_read_b32 v[vgprValuC+5], v[vgprLocalReadAddrB] offset:128 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 1) * bpe(2)
ds_read_b32 v[vgprValuC+6], v[vgprLocalReadAddrB] offset:256 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 2) * bpe(2)
ds_read_b32 v[vgprValuC+7], v[vgprLocalReadAddrB] offset:384 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 3) * bpe(2)
...
/* local read a */
ds_read_b32 v[vgprValuC+0], v[vgprLocalReadAddrA] offset:1024 // offset : (iter(1) * MT0 * MFMA_K + MT0 * 0) * bpe(2)
ds_read_b32 v[vgprValuC+1], v[vgprLocalReadAddrA] offset:1152 // offset : (iter(1) * MT0 * MFMA_K + MT0 * 1) * bpe(2)
ds_read_b32 v[vgprValuC+2], v[vgprLocalReadAddrA] offset:1280 // offset : (iter(1) * MT0 * MFMA_K + MT0 * 2) * bpe(2)
ds_read_b32 v[vgprValuC+3], v[vgprLocalReadAddrA] offset:1408 // offset : (iter(1) * MT0 * MFMA_K + MT0 * 3) * bpe(2)

/* local read b */
ds_read_b32 v[vgprValuC+4], v[vgprLocalReadAddrB] offset:1024 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 0) * bpe(2)
ds_read_b32 v[vgprValuC+5], v[vgprLocalReadAddrB] offset:1152 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 1) * bpe(2)
ds_read_b32 v[vgprValuC+6], v[vgprLocalReadAddrB] offset:1280 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 2) * bpe(2)
ds_read_b32 v[vgprValuC+7], v[vgprLocalReadAddrB] offset:1408 // offset : (iter(1) * MT1 * MFMA_K + MT1 * 3) * bpe(2)
